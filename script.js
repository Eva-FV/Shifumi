  ...
  function game() {
    ...
    if(playerScore === 3 || computerScore === 3) {
      if(playerScore > computerScore) {
        result.textContent = `Tu as ${playerScore} points et l'ordinateur à ${computerScore} points. GG tu as gagner!`;
        result.style.color = 'green';
        setTimeout( () => {
            result.textContent = "";
        }, 1700);
      } else {
        result.textContent = `Tu as ${playerScore} points et l'ordinateur à ${computerScore} points. Désolé, tu as perdu!`;
